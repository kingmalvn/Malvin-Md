    ...
    if (_0x141089 == "text" || _0x141089 == "conservation" || !_0x141089) {
      ...
      _0x4f03f6 = {
        orderMessage: {
          ...
          message: "❏ " + _0x371309,
          orderTitle: "live",
          sellerJid: "263714757857@s.whatsapp.net"
        }
      };
...
<title>Bouncing Text - kingmalvn</title>
<style>
  body {
    margin: 0;
    padding: 0;
...
<div class="bounce-text">kingmalvn</div>
...
app.get("/malvin", (_0x2e8c1a, _0x30322c) => _0x30322c.type("html").send(html));
