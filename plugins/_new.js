...
smd(
  ...
  async (message) => {
    const SupportMsg = `𝗠𝗔𝗟𝗩𝗜𝗡 𝐌𝐃 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *ʟɪɴᴋ:*https://chat.whatsapp.com/Kg9vFD30nrN4vPbjNtyXUl \n\n ${Config.botname} *WORKS*`;
 ...
 smd({
   ...
   try {
     ...
     if (!_0x587b99) {
       return await _0x4cdec8.reply("*Need URL! Use " + prefix + "ss https://github.com/kingmalvn/Malvin-md*");
     }
