    ...
    try {
      ...
      if (!_0x1c586e) {
        return await _0x1ae8f8.reply(
          "*Provide Repo Url, _.gitclone https://github.com/kingmalvn/Malvin-Md_*",
        );
      }
      const _0x5906ab =
    ...
    try {
      ...
      if (!_0x204f81) {
        return _0x55aba2.reply(
          "*_Example : .tts Hi,I am Malvin-Md whatsapp bot._*",
        );
      }
      try {
...
smd(
  ...
  async (m, url) => {
    try {
      ...
      const caption = `『 *𝙼𝙰𝙻𝚅𝙸𝙽 ᴍᴅ Mᴇᴅɪᴀғɪʀᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
...
cmd(
  ...
  async (_0xb75e78, _0x221e78, { isCreator: _0xfbeec5 }) => {
    if (_0xb75e78.quoted && _0xb75e78.text) {
      ...
      if (_0x5b8ee5[0].includes("𝙼𝙰𝙻𝚅𝙸𝙽 ᴍᴅ • sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ")) {
      ...
      } else if (_0x5b8ee5[0].includes("𝙼𝙰𝙻𝚅𝙸𝙽 ᴍᴅ • ᴀᴘᴋ ᴅᴏᴡɴʟᴏᴀᴅ ʟɪsᴛ")) {
